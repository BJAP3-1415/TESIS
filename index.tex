...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, coltitle=black, titlerule=0mm, left=2mm, toprule=.15mm, colback=white, leftrule=.75mm, rightrule=.15mm, breakable, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white]
